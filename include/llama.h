...
extern "C" {
    ...
    struct llama_model_params {
        ...
        bool use_bucket_mul;  // build bucket views when loading model and use effort-based CPU matmul
        float bucket_mul_effort;     // nominal effort (e.g. 0.5)
        float bucket_mul_effort_min; // min effort when system busy (e.g. 0.25)
        float bucket_mul_cpu_threshold;  // average CPU usage %% (0-100) above which reduce effort (999 = disabled)
    };
